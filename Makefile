...
BENCHMARK_FILE_LIST ?= benchmark_support.v,benchmark_fixtures.v,benchmark_live.v,image_load.v,sibling_cache.v,image_resource.v,main.v,app.v,checkerboard.v,scanner.v,viewport.v
...
TEST_FILES ?= app_test.v benchmark_test.v checkerboard_test.v cli_test.v filter_test.v flip_test.v image_resource_test.v keys_test.v main_test.v pan_test.v scanner_test.v scroll_test.v sibling_cache_test.v viewport_test.v
