...
TEST_FILES ?= app_test.v checkerboard_test.v cli_test.v filter_test.v flip_test.v keys_test.v main_test.v pan_test.v scanner_test.v scroll_test.v viewport_test.v
